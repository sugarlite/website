...
export const DEFAULT_OG_IMAGE = 'https://sugarlite.top/og-image-v2.png';
// WebP fallback for platforms with modern crawlers (Telegram, Slack, iMessage).
export const DEFAULT_OG_IMAGE_MODERN = 'https://sugarlite.top/og-image-v2.webp';
