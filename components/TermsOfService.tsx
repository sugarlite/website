...
const TermsOfService: React.FC<TermsOfServiceProps> = ({ lang, onNavigate }) => {
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          {tArray("terms.sections").map((section: any, index: number) => (
            <section key={index}>
                ...
                <div className="mt-4 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg">
                  ...
                  {section.phoneLabel && (
                    <p className="text-slate-700 dark:text-slate-300 mt-2">
                      {section.phoneLabel}: +86-XXX-XXXX-XXXX
                    </p>
                  )}
                </div>
              )}
